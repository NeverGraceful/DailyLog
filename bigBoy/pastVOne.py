...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.DATE_DISPLAYED.setGeometry(QtCore.QRect(60, 250, 211, 101))
        font = QtGui.QFont()
        ...
        self.RETURN.setGeometry(QtCore.QRect(130, 400, 75, 61))
        self.RETURN.setObjectName("RETURN")
        self.PAST_TEXT = QtWidgets.QLabel(Dialog)
        self.PAST_TEXT.setGeometry(QtCore.QRect(370, 40, 261, 221))
        ...
        self.SAVE_PAST.setGeometry(QtCore.QRect(460, 520, 75, 23))
        self.SAVE_PAST.setObjectName("SAVE_PAST")
        self.PAST_DRAWING = QtWidgets.QLabel(Dialog)
        self.PAST_DRAWING.setGeometry(QtCore.QRect(360, 280, 281, 191))
