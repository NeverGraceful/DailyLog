...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.AVATAR_BODY.setGeometry(QtCore.QRect(20, 40, 175, 350))
        self.AVATAR_BODY.setObjectName("AVATAR_BODY")
        self.AVATAR_HAT = QtWidgets.QLabel(Dialog)
        self.AVATAR_HAT.setGeometry(QtCore.QRect(20, 40, 175, 350))
        self.AVATAR_HAT.setObjectName("AVATAR_HAT")
        self.AVATAR_CLOTHES = QtWidgets.QLabel(Dialog)
        self.AVATAR_CLOTHES.setGeometry(QtCore.QRect(20, 40, 175, 350))
